...
figure(2), hold on
figure(2), plot(X1(1,y1==1),X1(3,y1==1),'r.',X1(1,y1==2),X1(3,y1==2),'bo')

figure(3), hold on
figure(3), plot(X1(2,y1==1),X1(3,y1==1),'r.',X1(2,y1==2),X1(3,y1==2),'bo')
...
figure(3), plot(X_proj1(1,:),X_proj1(2,:),'k.',X_proj2(1,:),X_proj2(2,:),'ko')
figure(3), axis equal
pause
