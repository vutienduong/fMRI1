...
for j=1:6
    ...
    for i=1:num_t_test
        ...
        [cLbest,Jmax]= exhaustiveSearch(c1_train(inds,:),c2_train(inds,:),'ScatterMatrices',[10]);
        fprintf('\n Exhaustive Search -> Best of ten: ');
        fprintf('(%d) ',inds(cLbest));
        
        [cLbestSFS,JSFS]=SequentialForwardSelection(c1_train(inds,:),c2_train(inds,:),'ScatterMatrices',10);
