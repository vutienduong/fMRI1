...
for j=1:6
    ...
    [info2,data2,meta2] = transformIDM_selectActiveVoxact(info,data,meta,200,[2,3]);
    ...
    examplesPS = examplesPR(:,1:150); 
    examplesSS = examplesSR(:,1:150);
    ...
    for i=1:num_t_test
        ...
        itt = 30; % number of weak classifiers
